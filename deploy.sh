...
PLUGINSLUG="simple-attribution"
CURRENTDIR=`pwd`
MAINFILE="simple-attribution.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="section214" # your svn username
